...
export const GetAllproperties = async ({ id, isapproved, page, limit }) => {
  ...
  try {
    ...
    let result = await fetch(
      `${BaseUrl}/Admin/properties/category/${id}?${params.toString()}`,
      {
        method: "GET",
        headers: {
...
export const Getsellarproductbyid = async (id) => {
  ...
  try {
    let result = await fetch(`${BaseUrl}/product/get/products/${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
        token: token,
...
export const GetAllpropertiescount = async () => {
  ...
  try {
    let result = await fetch(`${BaseUrl}/Admin/get/property/counts`, {
      method: "GET",
      headers: {
        "Content-type": "application/json",
        token: token,
