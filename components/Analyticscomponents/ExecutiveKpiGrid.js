...
export default function ExecutiveKpiGrid({ summary, bookingStatus, payoutStats, disputeStats, loading }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white border border-neutral-200 p-5 shadow-sm hover:shadow-md transition-all group">
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-semibold text-neutral-500 uppercase tracking-wider">
            Gross Platform Volume
          </span>
          <div className="p-2 rounded-xl bg-[#FFF1E6] text-[#FF6900] group-hover:scale-110 transition-transform">
            <ReceiptIndianRupee className="w-5 h-5" />
          </div>
        </div>
        <div className="text-2xl font-bold text-neutral-900 tracking-tight mb-1">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white border border-neutral-200 p-5 shadow-sm hover:shadow-md transition-all group">
        ...
        <div className="text-2xl font-bold text-neutral-900 tracking-tight mb-1">
          {totalBookings}{" "}
          <span className="text-xs font-normal text-neutral-500">stays</span>
        </div>
        <div className="flex items-center gap-2 text-xs text-neutral-500">
      ...
      <Link
        href="/payouts"
        className="relative overflow-hidden rounded-2xl bg-white border border-neutral-200 p-5 shadow-sm hover:shadow-md hover:border-[#FF6900]/40 transition-all group block"
      >
        <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="text-neutral-300">•</span>
          <span className="text-neutral-500">1-Click RazorpayX</span>
        </div>
      ...
      <Link
        href="/disputes"
        className="relative overflow-hidden rounded-2xl bg-white border border-neutral-200 p-5 shadow-sm hover:shadow-md hover:border-rose-400 transition-all group block"
      >
        <div className="flex items-center justify-between mb-3">
          <span className="text-xs font-semibold text-neutral-500 uppercase tracking-wider flex items-center gap-1">
            Dispute Resolution
        ...
        <div className="text-2xl font-bold text-neutral-900 tracking-tight mb-1 flex items-center gap-2">
          <span>{openDisputes}</span>
          <span className="text-xs font-normal text-neutral-500">active cases</span>
        </div>
        <div className="flex items-center gap-2 text-xs">
          {urgentDisputes > 0 ? (
